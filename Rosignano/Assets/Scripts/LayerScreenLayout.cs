    ...
    void Update()
    {
        for (int i = 0; i < layerPanels.Length; i++){
            ...
            if(Screen.orientation == ScreenOrientation.Portrait){
                layerPanels[i].GetComponent<RectTransform>().offsetMin = new Vector2((i+1) * 740f, 0);
                layerPanels[i].GetComponent<RectTransform>().offsetMax = new Vector2((i+1) * 740f, 0);
            }else{
                layerPanels[i].GetComponent<RectTransform>().offsetMin = new Vector2((i+1) * 1400f, 0);
                layerPanels[i].GetComponent<RectTransform>().offsetMax = new Vector2((i+1) * 1400f, 0);
            }
        }
